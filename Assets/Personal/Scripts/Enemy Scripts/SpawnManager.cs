...
public class SpawnManager : MonoBehaviour {
    ...
    public enum EnemyType : int { Cylinder = 0, Humanoid = 1, SpiderSwarm = 2, CowardlyWizard = 3, Birdie = 4};
    ...
    float[] spawnTimers = { 0, 0, 0, 0, 0};
    float[] baseTimesToNextSpawn = {1, 3, 4, 4, 4};
    float[] spawnTimeRanges = {0.5f/2, 2/2, 2/2, 2/2, 2/2};
    float[] timesOfNextSpawn = {0, 0, 0, 0, 0}; 
    GameObject player;
